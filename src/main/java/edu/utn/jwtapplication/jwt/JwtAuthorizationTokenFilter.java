package edu.utn.jwtapplication.jwt;
...
public class JwtAuthorizationTokenFilter extends OncePerRequestFilter {
    ...
    private final Logger logger = LoggerFactory.getLogger(this.getClass());//The org.slf4j.Logger interface is the main user entry point of SLF4J API. It is expected that logging takes place through concrete implementations of this interface.
